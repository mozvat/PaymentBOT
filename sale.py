...
print "<h2>POS http client requesting a sale</h2>"
print "query_string: " + query_string + "<br>"

print "<h2>Transaction query_string sent to PaymentsBOT</h2>"
...
print response
data = response.json()
print "Transaction response Status:" + data["CmdStatus"]
print "<br>Transaction response Text: " + data["TextResponse"]
print "<br>Authorization Code: " + data["AuthCode"]
